...
import { type Theme, type ThemeProps, changeTheme, getTheme, withTheme } from '../services/ThemeContext.js'
      ...
      <SceneWrapper hasTabs={false}>
        <ScrollView>
          ...
          <SettingsRow
            ...
            right={
              isLocked ? (
                <IonIcon name="ios-lock" color={theme.iconTappable} size={iconSize} />
              ) : (
                <IonIcon name="ios-unlock" color={theme.iconTappable} size={iconSize} />
              )
            }
